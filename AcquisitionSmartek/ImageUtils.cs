...
namespace AcquisitionSmartek
{
    class ImageUtils
    {
        public static void CopyToBitmap(gige.IImageBitmap srcBitmap, ref Bitmap bitmap, ref BitmapData bd, ref PixelFormat pixelFormat, ref Rectangle rect, ref UInt32 pixelType)
        {
            UInt32 sizeX, sizeY;
